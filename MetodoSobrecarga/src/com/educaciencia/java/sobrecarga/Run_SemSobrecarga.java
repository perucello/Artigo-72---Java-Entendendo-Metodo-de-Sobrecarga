 ...
 * 
 * Nós não utilizaremos de Método de Sobrecarga.
 * 
 */

public class Run_SemSobrecarga {
	...
	public static void main(String[] args) {
		...
		int n4 = 1;
		int n5 = 2;
		calculaDoisAtributos(n1, n2);
		calculaTresAtributos(n1, n2, n3);
		calculaQuatroAtributos(n1, n2, n3, n4);
		calculaCincoAtributos(n1, n2, n3, n4, n5);
	}
	
	/** Nesse metodo, iremos realizar calculos aritimeticos de dois atributos que receberemos externamente*/
	public static void calculaDoisAtributos(int n1, int n2) {
	...
	public static void calculaTresAtributos(int n1, int n2, int n3) {
	...
	public static void calculaQuatroAtributos(int n1, int n2, int n3, int n4) {
	...
	public static void calculaCincoAtributos(int n1, int n2, int n3, int n4, int n5) {
